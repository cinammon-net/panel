...
class CacheSettingsCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        // Solo si se selecciona Redis, se solicita la configuración de Redis
        if ($this->variables['CACHE_STORE'] === 'redis') {
            $this->requestRedisSettings();

            // Solo llamamos a este comando si Redis es seleccionado para las colas
        ...
        // Escribimos los cambios en el archivo .env
